...
###################################
## modified guided one-sided test
emp_p_with_sign <- function( x, y, p, c, n_perm = 100, ncores = 1){
...
for(frac in c(0, .125, .25, .5)){
  ...
  ## do the modified 1-sided test, split by the sign of the statistic
  p_modi = emp_p_with_sign( x, y, p, c, n_perm = 1000)
...
pdf(paste0('perm_p_plot_0to0.5_20221123.pdf'), width = 6, height = 8)
